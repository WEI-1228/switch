...
charging_csv_path = "/home/ljw/switch/input1/outputs-带电动汽车/ChargeStorage.csv"
discharging_csv_path = "/home/ljw/switch/input1/outputs-带电动汽车/DischargeStorage.csv"
...
zones = ['Tibet-Battery_Storage-11202-2']
...
for i, z in enumerate(zones):
    ...
    if tps:
        save_path = f"storage/{tps}/{z}/"
    else:
        save_path = f"storage/avg/{z}/"
